                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true"  scope="col">Tên người yêu cầu</th>
                                    <th data-sortable="true"  scope="col">ID yêu cầu</th>
                                    <th data-sortable="true"  scope="col">Biển số xe</th>
                                    <th data-sortable="true"  scope="col">Chứng nhận sở hữu xe</th>
                                    <th data-sortable="true"  scope="col">Thời gian gửi yêu cầu</th>
                            ...
                            <tbody>
                                @foreach ($carTickets['created'] as $key => $carTicketCreated)
                                    <tr>
                                        ...
                                        <th scope="col">{{ isset($carTicketCreated->user)?$carTicketCreated->user->name:"Tài khoản chưa đăng ký" }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                ...
                                                onclick="updateCarResult(['{{isset($carTicketCreated->user)?$carTicketCreated->user->id:'Tài khoản chưa đăng ký'}}',
                                                '{{ isset($carTicketCreated->user)?$carTicketCreated->user->name:'Tài khoản chưa đăng ký'}}',
                                                ...
                                                '{{isset($carTicketCreated->response_require)?($carTicketCreated->response_require==RESPONSE_VIA_EMAIL?$carTicketCreated->user->email:$carTicketCreated->user->phone_number):$carTicketCreated->email_require}}',
                                                '{{$carTicketCreated->id}}',
                        ...
                        data-check-on-init="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true"  scope="col">Biển số xe</th>
                                    <th data-sortable="true"  scope="col">Chứng nhận sở hữu xe</th>
                                    <th data-sortable="true"  scope="col">Thời gian cập nhật</th>
                                    <th data-sortable="true"  scope="col">Trạng thái</th>
                                    @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                        <th scope="col">Thao tác</th>
                                    @endif
                            ...
                            <tbody>
                                @foreach ($carTickets['completed'] as $key => $carTicketCompleted)
                                    <tr>
                                        <th scope="col">{{ $key+1 }}</th>
                                        <th scope="col">{{ isset($carTicketCompleted->user)?$carTicketCompleted->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                ...
                                                onclick='updateCarResult(["{{isset($carTicketCompleted->user)?$carTicketCompleted->user->id:"Tài khoản chưa đăng ký"}}",
                                                "{{ isset($carTicketCompleted->user)?$carTicketCompleted->user->name:"Tài khoản chưa đăng ký"}}",
                                                ...
                                                "{{isset($carTicketCompleted->response_require)?($carTicketCompleted->response_require==RESPONSE_VIA_EMAIL?$carTicketCompleted->user->email:$carTicketCompleted->user->phone_number):$carTicketCompleted->email_require}}",
                        ...
                        data-check-on-init="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true"  scope="col">Tên người yêu cầu</th>
                                    <th data-sortable="true"  scope="col">ID yêu cầu</th>
                                    <th data-sortable="true"  scope="col">Tên kiểm tra (Tiếng Nga)</th>
                                    <th data-sortable="true"  scope="col">Tên kiểm tra (Tiếng Anh)</th>
                                    <th data-sortable="true"  scope="col">Ngày sinh</th>
                                    <th data-sortable="true"  scope="col">Mã số hộ chiếu</th>
                                    <th data-sortable="true"  scope="col">Ngày hết hạn hộ chiếu</th>
                                    <th data-sortable="true"  scope="col">Thời gian gửi yêu cầu</th>
                            ...
                            <tbody>
                                @foreach ($entryBans['created'] as $key => $entryBanCreated)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{ isset($entryBanCreated->user)?$entryBanCreated->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                ...
                                                onclick="updateEntryBan([
                                                    '{{isset($entryBanCreated->user)?$entryBanCreated->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($entryBanCreated->user)?$entryBanCreated->user->name:'Tài khoản chưa đăng'}}',
                                                    ...
                                                    '{{isset($entryBanCreated->response_require)?($entryBanCreated->response_require==RESPONSE_VIA_EMAIL?$entryBanCreated->user->email:$entryBanCreated->user->phone_number):$entryBanCreated->email_require}}',
                        ...
                        data-check-on-init="true">
                            ...
                            <tbody>
                                @foreach ($entryBans['completed'] as $key => $entryBanCompleted)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{ isset($entryBanCompleted->user)?$entryBanCompleted->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                <a class="action-account-btn" style="color:green;"
                                                onclick="updateEntryBan([
                                                    '{{isset($entryBanCompleted->user)?$entryBanCompleted->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($entryBanCompleted->user)?$entryBanCompleted->user->name:'Tài khoản chưa đăng ký'}}',
                                                    ...
                                                    '{{isset($entryBanCompleted->response_require)?($entryBanCompleted->response_require==RESPONSE_VIA_EMAIL?$entryBanCompleted->user->email:$entryBanCompleted->user->phone_number):$entryBanCompleted->email_require}}',
                        ...
                        data-check-on-init="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true"  scope="col">Tên kiểm tra (Tiếng Nga)</th>
                                    <th data-sortable="true"  scope="col">Ngày sinh</th>
                                    <th data-sortable="true"  scope="col">INN</th>
                                    <th  data-sortable="true" scope="col">Mã số hộ chiếu</th>
                                    <th data-sortable="true"  scope="col">Ngày hết hạn hộ chiếu</th>
                                    <th data-sortable="true"  scope="col">Thời gian gửi yêu cầu</th>
                            ...
                            <tbody>
                                @foreach ($taxDebt['created'] as $key => $taxDebtCreated)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{ isset($taxDebtCreated->user)?$taxDebtCreated->user->name : 'Tài khoản chưa đăng ký'}}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                ...
                                                onclick="updateTaxDebt([
                                                    '{{isset($taxDebtCreated->user)?$taxDebtCreated->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($taxDebtCreated->user)?$taxDebtCreated->user->name : 'Tài khoản chưa đăng ký'}}',
                                                    '{{$taxDebtCreated->name }}',
                                                    ...
                                                    '{{isset($taxDebtCreated->response_require)?($taxDebtCreated->response_require==RESPONSE_VIA_EMAIL?$taxDebtCreated->user->email:$taxDebtCreated->user->phone_number):$taxDebtCreated->email_require}}',
                        ...
                        data-check-on-init="true">
                            ...
                            <tbody>
                                @foreach ($taxDebt['completed'] as $key => $taxDebtcompleted)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{isset($taxDebtcompleted->user)? $taxDebtcompleted->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                <a class="action-account-btn" style="color:green;"
                                                onclick="updateTaxDebt([
                                                    '{{isset($taxDebtcompleted->user)?$taxDebtcompleted->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($taxDebtcompleted->user)?$taxDebtcompleted->user->name:'Tài khoản chưa đăng ký'}}',
                                                    ...
                                                    '{{isset($taxDebtcompleted->response_require)?($taxDebtcompleted->response_require==RESPONSE_VIA_EMAIL?$taxDebtcompleted->user->email:$taxDebtcompleted->user->phone_number):$taxDebtcompleted->email_require}}',
                        ...
                        data-check-on-init="true">
                            ...
                            <tbody>
                                @foreach ($adminis['created'] as $key => $adminisCreated)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{ isset($adminisCreated->user)?$adminisCreated->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                ...
                                                onclick="updateAdminis([
                                                    '{{isset($adminisCreated->user)?$adminisCreated->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($adminisCreated->user)?$adminisCreated->user->name:'Tài khoản chưa đăng ký'}}',
                                                    '{{$adminisCreated->name }}',
                                                    ...
                                                    '{{isset($adminisCreated->response_require)?($adminisCreated->response_require==RESPONSE_VIA_EMAIL?$adminisCreated->user->email:$adminisCreated->user->phone_number):$adminisCreated->email_require}}',
                        ...
                        data-check-on-init="true">
                            ...
                            <tbody>
                                @foreach ($adminis['completed'] as $key => $adminiscompleted)
                                    <tr>
                                        <th scope="col">{{ $key +1 }}</th>
                                        <th scope="col">{{isset($adminiscompleted->user)? $adminiscompleted->user->name:'Tài khoản chưa đăng ký' }}</th>
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->inRoles([ROLE_SUPER_ADMIN, ROLE_ADMIN]))
                                            <th scope="col">
                                                <a class="action-account-btn" style="color:green;"
                                                onclick="updateAdminis([
                                                    '{{isset($adminiscompleted->user)?$adminiscompleted->user->id:'Tài khoản chưa đăng ký'}}',
                                                    '{{isset($adminiscompleted->user)?$adminiscompleted->user->name:'Tài khoản chưa đăng ký'}}',
                                                    ...
                                                    '{{isset($adminiscompleted->response_require)?($adminiscompleted->response_require==RESPONSE_VIA_EMAIL?$adminiscompleted->user->email:$adminiscompleted->user->phone_number):$adminiscompleted->email_require}}',
