                    ...
                    <form method="POST" action="{{ route('auth.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                {{-- <input id="" type="phone" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email"> --}}
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary normal-button" id="registerSubmit"
                                    name="registerSubmit" value="">
                                    Đăng ký
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#phone').on('change', function() {
            $('#registerSubmit').val(phoneInput.getNumber());
        });
    })
</script>
