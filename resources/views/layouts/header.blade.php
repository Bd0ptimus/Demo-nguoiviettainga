...
<nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm"
    ...
    <div class="d-flex justify-content-between" style="width:96vw; height:100%; padding : 0px; margin:0px 2vw;">
        <div class="d-flex justify-content-start" >
            ...
            <img onclick="logoClick()" id="logo-mb" src="{{asset('storage/logo/logo-main.png')}}" style="z-index:1500; margin-top:-10px; height : 60px;width:auto; cursor:pointer;">
            <img onclick="logoClick()" id="logo-pc" src="{{asset('storage/logo/logo-main-pc.png')}}" style="z-index:1500;  height : 40px;width:auto; cursor:pointer;">
...
<nav class="navbar navbar-expand-md navbar-light bg-light shadow-lg bg-body rounded mb-only"
    ...
    <div class="d-flex justify-content-around" style="width:100%; height:100%; padding : 0px; margin:0px 5px;">
        ...
        @else
            <div class="d-flex justify-content-center">
                <i class="fa-solid fa-bell fa-2xl footer-icon"></i>
            </div>
        @endif
        <div class="d-flex justify-content-center">
