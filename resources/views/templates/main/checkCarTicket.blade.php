    ...
    <div class="modal-dialog modal-dialog-centered " role="document"
        ...
        <div class="modal-content">
            ...
            <div class="modal-header d-flex justify-content-center" style="position:relative;">
                <h4 style="font-size:20px; font-weight:bold; text-align:center;  padding:0px 50px;">Kiểm tra phạt xe
                </h4>
                <span id="carTiket-modal-close" style=" position:absolute; right:10px; top:5px;"
            ...
            <div class="modal-body">
                ...
                <div class="row col-ms-6" style="margin-top: 20px;">
                    ...
                    @if (Admin::user() !== null)
                        @if (
                            ...
                            <h6 style="color:red;">Bạn chưa đăng ký email hoặc số điện thoại : </h6><span><a
                                    class="text-link"
                                    @if (Admin::user() !== null) href="{{ route('user.index', ['userId' => Admin::user()->id]) }} @endif">cập
                                    nhật</a></span>
                        @else
                    ...
                    @else
                        ...
                        <input maxlength="55" id="email-receiver-carTicket" name='emailReceiver' type="email"
...
<script type="text/javascript">
    function carTicketResetFormStyle() {
        ...
        $('#email-receiver-carTicket').css('border-color', setupBorderColor);
    ...
    $(document).ready(function() {
        ...
        $('#carTicketCheckingServiceBtn').on('click', function() {
            ...
            if (userId == '') {
                if ($('#email-receiver-carTicket').val() == "") {
                    $('#email-receiver-carTicket').css('border-color', 'red');
                    haveError = true;
                } else {
                    emailReceiver = $('#email-receiver-carTicket').val();
                }
            } else {
