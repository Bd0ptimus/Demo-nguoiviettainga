    ...
    <div class="modal-dialog modal-dialog-centered " role="document"
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-center" style="position:relative;">
                ...
                <h4 style="font-size:20px; font-weight:bold; text-align:center; padding:0px 50px;">Kiểm tra lỗi hành
                    chính</h4>
                <span id="adminis-modal-close" style=" position:absolute; right:10px; top:5px;"
            ...
            <div class="modal-body">
                ...
                <form id="adminisEntryBan" class="adminisModalBody" method="POST" action=""> @csrf
                    <div class="row my-1">
                        ...
                        <div class="col-xs-7 h-100 m-0">
                            <input maxlength="25" id="adminis-nameRussian" name='adminis-nameRussian' type="text"
                    ...
                    <div class="row my-1">
                        ...
                        <div class="col-xs-7 h-100 m-0">
                            <input maxlength="25" id="adminis-dob" name='adminis-dob' type="date"
                                class="form-control h-100" value="" required />
                        </div>
                    </div>
                    ...
                    <div class="row my-1">
                        ...
                        <div class="col-ms-6" style="width : 60%;">
                            ...
                            <input maxlength="55" id="adminis-passportExpiredDate" name='adminis-passportExpiredDate'
                ...
                <div class="row col-ms-6" style="margin-top: 20px;">
                    ...
                    @else
                        ...
                        <input maxlength="55" id="email-receiver" name='emailReceiver' type="email"
...
<script type="text/javascript">
    function adminisResetFormStyle() {
        ...
        $('#email-receiver').css('border-color', setupBorderColor);
        ...
        $('#adminisCheckingServiceBtn').on('click', function() {
            ...
            if (userId == '') {
                if ($('#email-receiver').val() == "") {
                    $('#email-receiver').css('border-color', 'red');
                    haveError = true;
                } else {
                    emailReceiver = $('#email-receiver').val();
                }
            } else {
