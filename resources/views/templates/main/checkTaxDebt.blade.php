    ...
    <div class="modal-dialog modal-dialog-centered " role="document"
        ...
        <div class="modal-content">
            ...
            <div class="modal-header d-flex justify-content-center" style="position:relative;">
                <h4 style="font-size:20px; font-weight:bold; text-align:center ;  padding:0px 50px;">Kiểm tra nợ thuế
                </h4>
                <span id="taxDebt-modal-close" style=" position:absolute; right:10px; top:5px;"
            ...
            <div class="modal-body">
                ...
                <form id="taxDebtEntryBan" class="taxDebtModalBody" method="POST" action=""> @csrf
                    <div class="row my-1">
                        ...
                        <div class="col-xs-7 h-100 m-0">
                            <input maxlength="25" id="taxDebt-nameRussian" name='taxDebt-nameRussian' type="text"
                    ...
                    <div class="row my-1">
                        ...
                        <div class="col-xs-7 h-100 m-0">
                            <input maxlength="25" id="taxDebt-dob" name='taxDebt-dob' type="date"
                                class="form-control h-100" value="" required />
                        </div>
                    </div>
                    ...
                    <div class="row my-1">
                        ...
                        <div class="col-ms-6" style="width : 60%;">
                            ...
                            <input maxlength="55" id="taxDebt-passportExpiredDate" name='taxDebt-passportExpiredDate'
                    ...
                    <div class="row my-1">
                        ...
                        <div class="col-xs-7 h-100 m-0">
                            <input maxlength="25" id="taxDebt-inn" name='taxDebt-inn' type="text"
                                class="form-control h-100" value="" required />
                        </div>
                    </div>
                </form>
                <div class="row col-ms-6" style="margin-top: 20px;">
                    ...
                    @if (Admin::user() !== null)
                        @if (
                            ...
                            <h6 style="color:red;">Bạn chưa đăng ký email hoặc số điện thoại : </h6><span><a
                                    class="text-link"href="{{ route('user.index', ['userId' => Admin::user() !== null ? Admin::user()->id : 0]) }}">cập
                                    nhật</a></span>
                        @else
                    ...
                    @else
                        ...
                        <input maxlength="55" id="email-receiver-taxDebt" name='emailReceiver' type="email"
...
<script type="text/javascript">
    function taxDebtResetFormStyle() {
        ...
        $('#email-receiver-taxDebt').css('border-color', setupBorderColor);
    }
    ...
    $(document).ready(function() {
        ...
        $('#taxDebtCheckingServiceBtn').on('click', function() {
            ...
            if (userId == '') {
                if ($('#email-receiver-taxDebt').val() == "") {
                    $('#email-receiver-taxDebt').css('border-color', 'red');
                    haveError = true;
                } else {
                    emailReceiver = $('#email-receiver-taxDebt').val();
                }
            } else {
