    ...
    <div class="project-content-section">
        <div class="row d-block justify-content-center" style="width:100%; margin:0px;">
            <div class="row d-flex justify-content-center"
                style="width:100%; margin:0px; padding:0px; height:auto; background-color:white;">
                <div class="user-main-sec">
                    <div class="user-image-sec d-flex justify-content-center">
                        <div class="user-image-showing-sec " style="position:relative;">
                            <img id="accountUserAvatar" class="user-image-showing"
                                src="{{ asset($user->user_avatar) }}">
                    ...
                    <div class="user-name-sec" style="position:relative;">
                        <div class="row user-name-text d-flex" style="width:calc(100%-20px); margin:0px;">
                            <h1 style="width:auto; font-weight: 800; color:black; font-size:25px;">{{ $user->name }}
                            </h1>
                        </div>
                    </div>
                        ...
                        @if (Admin::user() !== null && Admin::user()->id == $userId)
                            <div class="row d-flex user-action-btn-sec" style="width:100%; margin:0px; padding:0px;">
                                <div style="width:auto;" class="user-edit-profile-btn" onclick="changeUserInfoBtn()">
                                    <i class="fa-solid fa-pencil fa-xl"></i> <span
                                        class="user-edit-profile-btn-text">Chỉnh sửa thông tin cá nhân<span>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="user-newfeed-leftside" id="userInfoLeft">
                            ...
                            @if (Admin::user() !== null && Admin::user()->id == $userId)
                                <div class="user-newfeed-info-common">
                                    <div style="width:100%;" class="user-edit-profile-btn d-flex justify-content-center"
                                        onclick="changeDescriptionBtn()">
                                        <i class="fa-solid fa-pencil fa-xl icon-align"></i> <span
                                            class="user-edit-profile-btn-text"> Chỉnh sửa giới thiệu<span>
                                    </div>
                                </div>
                            @endif
                    ...
                    <div class="user-newfeed-info-sec">
                        ...
                        @if (Admin::user() !== null && Admin::user()->id == $userId)
                            <div class="user-newfeed-info-common">
                                <div style="width:100%;" class="user-edit-profile-btn d-flex justify-content-center"
                                    onclick="changeMainInfoBtn()">
                                    <i class="fa-solid fa-pencil fa-xl icon-align"></i> <span
                                        class="user-edit-profile-btn-text"> Chỉnh sửa thông tin<span>
                                </div>
                            </div>
                        @endif
                ...
                <div class="user-newfeed-rightside">
                    @if (Admin::user() !== null && Admin::user()->id == $userId)
                        <div class="user-newfeed-info-common" style="padding:0px;">
                            <div style="width:100%;" class="user-add-post-btn d-flex justify-content-center"
                                onclick="gotoCreatePostPage()">
                                <i class="fa-solid fa-circle-plus  fa-xl" style="margin-top:10px;"></i> <span
                                    class="user-edit-profile-btn-text">&emsp;Đăng bài viết mới<span>
                            </div>
                        </div>
                    @endif
                    <div id="myPost-load" class="row newfeed-sec" style="padding:0px; margin : 10px 0px;">
                        ...
                        @foreach ($posts as $post)
                            ...
                            <div class="row d-block justify-content-center newfeed-container2"
                                ...
                                @if (
                                    (Admin::user() !== null && Admin::user()->isRole(ROLE_USER)) ||
                                        (Admin::user() !== null &&
                                            Admin::user()->inRoles([ROLE_ADMIN, ROLE_SUPER_ADMIN]) &&
                                            Admin::user()->id == $userId))
                                    <hr />
                                    <div class="row d-flex justify-content-center"
                                        style="margin:10px 0px; padding:auto;">
                                        ...
                                        @if (Admin::user() !== null && Admin::user()->id == $userId)
                                            <div class="row newFeed-interact-sec2 d-flex justify-content-center"
                                                ...
                                                <i class="fa-solid fa-pen-to-square fa-xl interact-icon2"
                                                    style="color:#1d8daf"
                                ...
                                @endif
                                <hr />
                                <div id="commentSec-post-{{ $post->id }}"
                                    class="row justify-content-center mx-0 my-0" style="display:none;">
            ...
            <div class="user-main-sec" style="margin:0px; padding:0px; display:none;" id="userSettings">
                <div class="user-setting-section" id="userInfoLeft">
                    <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="oldPassword" type="text"
                                    ...
                                    value="{{ old('oldPassword') }}" required autocomplete="oldPassword" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="newPasswordConfirm" class="col-md-4 col-form-label text-md-end">Nhập lại mật
                                khẩu mới</label>

                            <div class="col-md-6">
                                <input id="newPasswordConfirm" type="password"
                                    class="form-control @error('newPasswordConfirm') is-invalid @enderror"
                                    name="newPasswordConfirm" required autocomplete="current-password">
