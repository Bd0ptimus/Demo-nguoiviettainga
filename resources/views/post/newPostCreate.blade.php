                                ...
                                <div class="row d-flex justify-content-start my-2">
                                    <div style="width:auto;">
                                        <label class="toggle" for="postForUserSelection">
                                            ...
                                            <span class="toggle-track" style="width: 40%;">
                                            ...
                                            <span class="form-text"  style="max-width: 60%;">
                                    ...
                                    <div style="display:none;"  id="searchUserSec">
                                        ...
                                        <div class="searchUserResultSec" id="searchUserResultList" style="z-index:1500;">
                                    ...
                                    <div style="display:none;"  id="searchUserChosen">
                                        <div class="userChosenSec d-block justify-content-center" style="position: relative;">
                                            <div class="d-flex justify-content-end" style="position: absolute; width:100%;">
                                                <i style="font-size:20px; cursor:pointer; margin-right:5px; z-index:1000;" class="fa-solid fa-xmark" onclick="removeUserChosen('{{Admin::user()->name}}', '{{Admin::user()->email}}')"></i>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        console.log('contact name in loading : ',userContactName );
    ...
    function chooseUser(userId,
                        ...
                        userPhone){
                            ...
                            $('#userContactName').val(userName);
                            $('#userChosenEmail').text(userEmail);
                            $('#userContactEmail').val(userEmail);
    ...
    function removeUserChosen(adminContactName, adminContactEmail){
        console.log('removeUserChosen');
        $('#userChosenId').val('');
        $('#searchUserChosen').hide();
        $('#userContactInfoPhoneFieldAdd').remove();
        $('#userContactName').val(adminContactName);
        $('#userContactEmail').val(adminContactEmail);
        reloadTellIn();
        console.log('user choosen clicked',userContactName );
